      ...
      <main>
        ...
        <section id="s1">
          <nav>
            ...
            <div className="nav-elem">
              <i className="ri-arrow-right-s-line"></i> Extera
            </div>
            <div className="nav-elem">
        ...
        <div id="s3">
          <div className="top">
            <div className="left">
              <h1>
                were crafting <br /> emotional experience <br />
                animated at improving Results
              </h1>
            </div>
          </div>
        </div>
        ...
        <div className="footer">
          <div>
            <h3>
              <span> Chicago.</span>  <span>Amsterdam. </span> <span> Paris.</span> 
              <h1>
                We <br /> Make <br /> Good <br />
                Shit <br />
                <small>Fb / Ins / Dri / Tw</small>
              </h1>
            </h3>
            <br /> <hr /> <br />
            <small> We'd love to hear from you --- biz@dogstudio.be</small>
          </div>
        </div>
      </main>
    </>
